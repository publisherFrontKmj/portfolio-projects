$(document).ready(function(){
    ...
    $(".filter_top .filter_txt").on("click", function(){
        if($(this).closest(".filter_top").hasClass("on")){
            $(this).closest(".filter_top").removeClass("on");
        }else{
            $(this).closest(".filter_top").addClass("on");
        }   
    });
    ...
    $(".el_detail_quick .quick_like").on("click", function(){
        if($(this).hasClass("on")){
            $(this).removeClass("on");
        }else{
            $(this).addClass("on");
    ...
    // 공유하기 팝업 on
    $(".el_detail_quick .quick_share").on("click", function(){
    ...
    // 신고하기 팝업 on
    $(".report_pop_button").on("click", function(){
        $(".ezlounge_popup_bg").addClass("on");
